...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String twentyPoints = "PointFiles/SmallerSet.input";
        String oneHundredPoints = "PointFiles/test_100.input";
        String oneThousandPoints = "PointFiles/test_1000.input";
        String tenThousandPoints = "PointFiles/test_10000.input";
